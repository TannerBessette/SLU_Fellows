...
rf_cv <- fit_resamples(rf_wf, RL_numeric, 
                       resamples = vfold_cv(RL_numeric, v = 3))
...
Create a dataset with just a subset of variables to provide a visual of a single tree:
```{r}
